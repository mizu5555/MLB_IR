...
def generate_answer(query: str, query_type: str, data: Dict) -> str:
    ...
    if query_type == 'factual':
        ...
        prompt = f"""Answer the query using the data provided.
...
Answer directly with the specific data asked. Keep it concise."""
        ...
        prompt = f"""Summarize the top players naturally.
...
st.sidebar.markdown(f"**賽季：** 2023-2024")
